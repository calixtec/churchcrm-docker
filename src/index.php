...
<head>
  ...
  <title>ChurchCRM is initializing</title>
</head>
  ...
  <div class="container">
    <div class="left-section">
      <div class="inner-content">
        <h1 class="heading">🔍</h1>
        <p class="subheading" style="color: yellow"><b>Your ChurchCRM instance is still initializing.</b></p>
        <br />
        <p class="subheading">Please, wait 2 or 3 minutes and try to access this page again.</p>
        <br />
      </div>
    </div>
